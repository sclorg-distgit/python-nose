...
Patch2:         fix-class-name-in-output.patch
...
%changelog
* Tue Jul 26 2016 Tomas Orsava <torsava@redhat.com> - 1.3.7-2
- Bootstrapping, step 2/2: with_docs 1

* Mon Jul 25 2016 Tomas Orsava <torsava@redhat.com> - 1.3.7-1
- Update to 1.3.7
- Bootstrapping, step 1/2: with_docs 0

* Wed Jan 21 2015 Robert Kuska <rkuska@redhat.com> - 1.3.4-2
- Build with docs

* Wed Jan 21 2015 Matej Stuchlik <mstuchli@redhat.com> - 1.3.4-1
- Update to 1.3.4

* Mon Nov 11 2013 Robert Kuska <rkuska@redhat.com> - 1.3.0-1
- Update to 1.3.0
